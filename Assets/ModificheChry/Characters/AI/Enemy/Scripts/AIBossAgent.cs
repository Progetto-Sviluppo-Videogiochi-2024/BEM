...
public class AIBossAgent : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // if (GestoreScena.killedEnemyIds.Contains(id) || !BooleanAccessor.istance.GetBoolFromThis("videoMutant")) { gameObject.SetActive(false); return; } // Non scommentarlo se no il boss quando appare scompare
